    ...
    methods: {
        list_callback: function (ajax_json) {  
            ...
            $('#pageLimit1').bootstrapPaginator({
                ...
                onPageClicked: (event, originalEvent, type, page)=> {
                    ...
                    jquery_ajax_obj({"url":ACTION_URL.business_list,"request_type":"post","post_data":this.search_param,"is_json_param":true,"callback_func":this.list_callback});
                }
            }); 
        ...
        del_record(id){            
            if(confirm("确定要删除此记录吗？")){
                jquery_ajax(ACTION_URL.business_delete,"post",id,true,()=>{
                    alert("操作成功");

var vue_instance = new Vue({
    ...
    methods: {
        list_callback: function (ajax_json) {              
            ...
            $('#pageLimit1').bootstrapPaginator({
                ...
                onPageClicked: (event, originalEvent, type, page)=> {
                    ...
                    jquery_ajax(ACTION_URL.product_capacities_list,"post",this.search_param,true,this.list_callback);  
                }
            }); 
        ...
        load_list:function(){                 
            ...
            jquery_ajax(ACTION_URL.product_capacities_list,"post",undefined,true,this.list_callback);      
        },
        del_record(id){            
            if(confirm("确定要删除此记录吗？")){
                jquery_ajax(ACTION_URL.product_capacities_delete,"post",id,true,()=>{
                    alert("操作成功");
